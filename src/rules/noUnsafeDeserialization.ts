...
export function noUnsafeDeserializationRule(
    ...
    const deserializationPatterns = [
        // Unsafe JSON.parse() with dynamic input
        {
            ...
            message: "Unsafe JSON.parse() with dynamic input - can lead to prototype pollution",
            severity: vscode.DiagnosticSeverity.Error,
            type: "no-json-parse-unsafe"
        },
        // Unsafe Object.assign() - To catch multiple arguments
        {
            pattern: /Object\.assign\s*\(\s*\{[^}]*\},\s*[^,)]+,\s*[a-zA-Z_$][\w$]*(\.[\w$]+)+/g,
            message: "Unsafe Object.assign() with user-controlled input - can lead to prototype pollution",
            severity: vscode.DiagnosticSeverity.Error,
        ...
        // Unsafe object spread
        {
            ...
            message: "Unsafe object spread with user-controlled input - can lead to prototype pollution",
            severity: vscode.DiagnosticSeverity.Warning,
            type: "object-merge-input"
        },
        // Deep merge operations - To catch library patterns
        {
            pattern: /\.(merge|deepMerge|deepAssign|extend|defaultsDeep)\s*\(\s*[^,]+,\s*[a-zA-Z_$][\w$]*\.[\w$]+/g,
        ...
        // JSON.parse with concatenation
        {
            ...
            message: "JSON.parse() with string concatenation - unsafe with user input",
            severity: vscode.DiagnosticSeverity.Error,
            type: "no-json-parse-unsafe"
        },
        // Unsafe Object constructor
        {
            ...
            message: "Unsafe Object constructor with user input - can lead to prototype pollution",
            severity: vscode.DiagnosticSeverity.Error,
